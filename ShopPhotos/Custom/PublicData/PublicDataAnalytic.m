...
- (void)analyticInterface:(NSDictionary *)data{
    ...
    @try {
        ...
        if(datas && datas.count > 0){
            ...
            congfing.handleCopyRequest = [RequestErrorGrab getStringwitKey:@"handleCopyRequest" toTarget:api];
            ...
            congfing.cancelConcernUser = [RequestErrorGrab getStringwitKey:@"cancelConcernUser" toTarget:api];
            ...
            congfing.useImageSearch = [RequestErrorGrab getStringwitKey:@"useImageSearch" toTarget:api];
            ...
            congfing.createVideo2 = [RequestErrorGrab getStringwitKey:@"createVideo2" toTarget:api];
            congfing.createVideo3 = [RequestErrorGrab getStringwitKey:@"createVideo3" toTarget:api];
