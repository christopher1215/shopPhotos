...
//    self.enter.layer.borderColor = [UIColor whiteColor].CGColor;
    ...
    [self.sure.titleLabel setFont:Font(17)];
    ...
    [self.cancel.titleLabel setFont:Font(17)];
